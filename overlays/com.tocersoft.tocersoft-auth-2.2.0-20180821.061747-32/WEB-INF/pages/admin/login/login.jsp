                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
                           		<form id="loginForm">
                                    ...
                                    <c:if test="${runMode == 'saas'}">
                                    <div class="form-group">
                                        <label class="sr-only" for="form-entcode">企业代码</label>
                                        <input  id="j_entcode" name="p2" placeholder="企业代码" onkeypress="if(event.keyCode == 13){login();return false;}" autocomplete="off" type="password" class="form-password form-control" >
                                    </div>
                                    </c:if>
