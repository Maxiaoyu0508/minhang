						...
						<table class="form-table">
							...
							<tr>
								...
								<td class="form-content" width="58%">
									<div class="reset-pwd-bar none">
										<span class="reset-low pwd-div-red">&nbsp;&nbsp;弱&nbsp;&nbsp;</span>
										<span class="reset-middle pwd-div-gray">&nbsp;&nbsp;中&nbsp;&nbsp;</span>
										<span class="reset-high pwd-div-gray">&nbsp;&nbsp;强&nbsp;&nbsp;</span>
									</div>
									<span id="resetPwdTip"></span>
								</td>
							</tr>
						</table>
					</form>
...
<%-- 				<input id="itemId" name="item.id" value="${item.id}" type="hidden" autocomplete="off"/> --%>
				...
				<table class="form-table mt3">
					...
					<tr>
						...
						<td class="form-content">
							<div class="pwd-bar">
								<span class="low pwd-div-red">&nbsp;&nbsp;弱&nbsp;&nbsp;</span>
								<span class="middle pwd-div-gray">&nbsp;&nbsp;中&nbsp;&nbsp;</span>
								<span class="high pwd-div-gray">&nbsp;&nbsp;强&nbsp;&nbsp;</span>
							</div>
