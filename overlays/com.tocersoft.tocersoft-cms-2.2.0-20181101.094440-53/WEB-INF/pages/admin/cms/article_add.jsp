						...
						<input id="itemId" name="item.id" value="${item.id}"  type="hidden">
							<div>
								<table class="form-table ">
									...
									<tr>
										<td class="form-title" rowspan="4">文章摘要：</td>
										<td class="form-content" colspan="3" rowspan="4">
											<textarea id="summary" name="item.summary" class="tc-textarea fl w" style="height:110px;">${item.summary}</textarea>
										</td>
