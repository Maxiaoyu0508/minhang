...
<html>
	<head>
		<base href="${ctxPath}" />
		<title>文章视屏管理 - 管理文章视屏</title>
		<jsp:include page="/WEB-INF/pages/admin/base/admin_css_inc.jsp" />
		<script type="text/javascript">var swfu;</script>
	</head>
	<body class="iframe-body">
	
		<form id="advPhotoForm" action="${ctxPath}/admin/cms/article/add_article_annex.htm" method="post">
					...
					<tr id="uploadCover">
						...
						<td class="form-content" rowspan="4">
							<div class="photo-add-div mr20 fl">
								...
								<input id="imgPath2" name="coverPath" value="coverPath" type="hidden"/>
								<input id="imgName2" name="coverName" value="coverName" type="hidden"/>
							</div>
						</td>
						<td class="form-content"></td>
					</tr>
		...
		<script src="${ctxPath}/static/admin/cms/article_annex_add.js" type="text/javascript"></script>
	</body>
</html>