...
<html>
	<head>
		<base href="${ctxPath}"/>
		<title>保存文章标签关联表</title>
		<jsp:include page="/WEB-INF/pages/admin/base/admin_css_inc.jsp"/>
	</head>
	<body class="iframe-body">
		<form id="saveForm" action="${ctxPath}/admin/cms/article/tag/saveCmsArticleTag.htm" method="post">
			<core:token/>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/cms/cms_article_tag_add.js?t=${sysVersion}"></script>
	</body>
</html>