...
<html>
	<head>
		<base href="${ctxPath}"/>
		<title>保存专栏内的推荐博主</title>
		<jsp:include page="/WEB-INF/pages/admin/base/admin_css_inc.jsp"/>
	</head>
	<body class="iframe-body">
		<form id="saveForm" action="${ctxPath}/admin/cms/column/blog/saveCmsColumnBlog.htm" method="post">
			<core:token/>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/cms/cms_column_blog_add.js?t=${sysVersion}"></script>
	</body>
</html>