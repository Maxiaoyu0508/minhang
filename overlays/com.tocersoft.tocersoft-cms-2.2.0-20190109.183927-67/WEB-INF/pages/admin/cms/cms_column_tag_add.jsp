...
<html>
	...
	<body class="iframe-body">
		<form id="saveForm" action="${ctxPath}/admin/cms/column/tag/saveCmsColumnTag.htm" method="post">
			<core:token/>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/cms/cms_column_tag_add.js?t=${sysVersion}"></script>
	</body>
</html>