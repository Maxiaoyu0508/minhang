...
function initFormValidator(){
    ...
    $("#blogAuthorId").formValidator({validatorGroup:1}).inputValidator({min:1,max:255,onErrorMin:"博主ID不能为空",onErrorMax:"博主ID长度过长"});
}
...
function initOperateBtn(){
	//保存博主与标签关联表
	$("#saveBtn").on("click",saveCmsBlogAuthorTag);
	//关闭窗口
