...
<html>
	...
	<body class="iframe-body">
		<div class="category-list fl">
			<div class="oper mb3">
				<form id="searchForm">
					...
					<input id="searchKey" name="condition.key" value="" class="tc-input-text fl mr5 w200" type="text" placeholder="根据会员姓名或收藏对象名称进行模糊查询"/>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/member/member_collection_index.js?t=${sysVersion}"></script>
	</body>
</html>