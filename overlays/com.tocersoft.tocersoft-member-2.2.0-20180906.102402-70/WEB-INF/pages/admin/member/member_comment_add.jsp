...
<html>
	...
	<body class="iframe-body">
		<form id="saveForm" action="${ctxPath}/admin/member/comment/saveMemberComment.htm" method="post">
			<core:token/>
			...
			<table class="form-table">
				...
				<tr>
					...
					<td class="form-content">
						<input id="score" name="item.score" value="${item.score}" type="text" class="tc-input-text w" autocomplete="off" />
					</td>
					<td class="form-content"></td>
				</tr>
				...
				<tr>
					...
					<td class="form-content">
						<input id="replyCommentId" name="item.replyCommentId" value="${item.replyCommentId}" type="text" class="tc-input-text w" autocomplete="off" />
					</td>
					<td class="form-content"></td>
				</tr>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/member/member_comment_add.js?t=${sysVersion}"></script>
	</body>
</html>