...
<html>
	...
	<div class="category-box clb">
		...
		<div id="categoryContentDiv" class="category-list fl pr" style="margin-top: -1px; border: 1px solid rgb(221, 221, 221); top: 10px; left: 10px; width: calc(100% - 175px);">
		<form id="saveForm" action="${ctxPath }/admin/member/right/saveRight.htm" method="POST">
			...
			<div class="welcome-right-title clb">
				<span class="ml10 fl wrt-font-title">操作权限</span>
				<a id="saveRightBtn" class="ui-button blue-skin" style="width:85px;text-align:center;" href="javascript:void(0);" >保存修改</a>
			</div>
		...
		<script src="${ctxPath}/static/admin/member/member_right_list.js?v=${sysVersion}"></script>
	</body>
</html>