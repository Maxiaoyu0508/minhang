...
function initFormValidator(){
    ...
    $("#objectId").formValidator({validatorGroup:1}).inputValidator({min:1,max:255,onErrorMin:"收藏对象ID不能为空",onErrorMax:"收藏对象ID长度过长"});
}
...
function initOperateBtn(){
	//保存会员收藏
    $("body").on("click","#saveBtn",saveMemberCollection);
	//关闭窗口
