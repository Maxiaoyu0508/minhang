...
<html>
	<head>
		<title>保存会员企业关联表</title>
		<jsp:include page="/WEB-INF/pages/admin/base/admin_meta_inc.jsp" />
		<jsp:include page="/WEB-INF/pages/admin/base/admin_css_inc.jsp" />
	</head>
	<body class="iframe-body">
		<form id="saveForm" action="${ctxPath}/admin/member/user/company/saveMemberUserCompany.htm" method="post">
			<core:token/>
			...
			<table class="form-table">
				...
				<tr>
					...
					<td class="form-content">
						<input id="memberCompanyId" name="item.memberCompanyId" value="${item.memberCompanyId}" type="text" class="tc-input-text w" autocomplete="off" />
					</td>
					<td class="form-content"></td>
				</tr>
				...
				<tr>
					...
					<td class="form-content">
						<input id="position" name="item.position" value="${item.position}" type="text" class="tc-input-text w" autocomplete="off" />
					</td>
					<td class="form-content"></td>
				</tr>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/member/member_user_company_add.js?t=${sysVersion}"></script>
	</body>
</html>