...
<html>
	...
	<span class="fl mt10">
		...
		<form id="saveForm" action="${ctxPath}/admin/member/do_open.htm" method="post">
			<core:token/>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/member/member_user_regist.js?t=${sysVersion}"></script>
	</body>
</html>