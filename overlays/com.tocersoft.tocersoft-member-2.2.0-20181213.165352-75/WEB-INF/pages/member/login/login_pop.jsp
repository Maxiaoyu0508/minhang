...
<html >
	<head>
		<meta charset="utf-8" />
		<title>会员登录 - 朗绿-健康家居材料采购平台</title>
		...
		<div class="lg-bg-img">
			<form id="loginForm" method="POST">
				<div style="width: 500px;" class="cb-content clb">
					<div class="f24bt tc mb20">账号登录</div>
					...
					<div style="margin: auto auto;width: 337px;color: #999999;" class="clb f14">
						<a  href="${ctxPath}/member/forget_email.htm" target="_blank" style="color: #999999;margin-top: 2px;" class="ml20 fr" id="loginBtn">忘记密码</a>
						<label class="fr"><input type="checkbox" class="vm" value="1" name="isRmbPwd"><span class="vm ml5">记住我</span></label>
					</div>
					<a href="${ctxPath}/member/regist.htm" target="_blank" class="login-a">帐号注册</a>
				</div>
			</form>
		</div>
		<jsp:include page="/WEB-INF/pages/front/base/inc_front_js.jsp"/>
		<script src="${ctxPath}/static/member/login/login_pop.js" type="text/javascript"></script>
	</body>
</html>