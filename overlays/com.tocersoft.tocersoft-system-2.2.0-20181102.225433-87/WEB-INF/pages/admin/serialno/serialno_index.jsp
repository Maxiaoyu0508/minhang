...
<html>
	...
	<body class="iframe-body">
			...
			<div class="welcome-right-title clb">
				...
				<form id="searchForm">
					<div class="oper-box clb">
						<a onClick="addSerialno();" class="ui-button blue-skin" href="javascript:void(0);">新增流水号表</a>
						<a onClick="doBatchDelSerialno();" class="ui-button green-skin" href="javascript:void(0);">批量删除</a>
						<input id="searchKey" name="condition.name" value="" class="tc-input-text w200 search-box" type="text" placeholder="流水号表模糊查询"/>
						<a onClick="searchSerialno();" class="ui-button green-skin" href="javascript:void(0);" >查询</a>
		...
		<script type="text/javascript" src="${ctxPath}/static/admin/serialno/serialno_index.js?v=${sysVersion}"></script>
	</body>
</html>