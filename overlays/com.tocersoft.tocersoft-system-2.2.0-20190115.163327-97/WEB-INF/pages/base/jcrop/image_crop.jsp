...
<div class="msg-box-content" style="height: 460px;" id="portrait-upload-div">
	...
	<form action="${ctxPath}/member/account/add_picture.htm" method="post" id="formPhoto4" enctype="multipart/form-data">
		...
		<div class="mt10 clb">
			<div style="float:left;">
				<input id="photo3" name="photo" value="" type="hidden">
			...
			<div style="float:left;overflow:hidden;">
				...
				<input id="imageFile3" name="uploadFile" type="file" class="input_f" data-max_siz="2097152" onchange="doFileUploadTx(this,event)" />上传图片</a>
			</div>
		</div>
		<div class="clb">
		<%-- 默认图片 --%>
