...
<div class="display-box">
	<ul class="display-box-ul">
		<c:forEach items="${uploadFile}" end="3" var="cmsChannels">
		<li>
			<a href="${ctxPath}/weixin/exhibit/list.htm?item.id=${cmsChannels.id}" style="background:url('${ctxPath}/upload/${cmsChannels.url}') no-repeat;background-size:cover;">
				<div class="display-text ">${cmsChannels.name}</div>
			</a>
		</li>
		</c:forEach>
	</ul>
