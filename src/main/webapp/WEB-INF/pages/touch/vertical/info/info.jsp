...
<style>
  .main-tab{width:100%;height:189px;flex-direction: row;display:flex;justify-content:center;position:absolute;left:0;bottom:0;}
  .main-tab .tab{flex:1;}
  .info-tab1{background:url("/static/touch/images/vinfo-tab1.png") no-repeat center center;}
  .info-tab2{background:url("/static/touch/images/vinfo-tab2.png") no-repeat center center;}
  .info-tab3{background:url("/static/touch/images/vinfo-tab3.png") no-repeat center center;}
  .info-tab4{background:url("/static/touch/images/vinfo-tab4.png") no-repeat center center;}
  .main-con{width:100%;height:1123px;background-color: #fff;}
  .main-con>.content-item{width:100%;height:100%;overflow:hidden;}
  .swiper-container .swiper-slide{height: auto;}
  .info1-view{width:763px;height:388px;margin:75px auto 50px;}
  .info1-view>img{width:100%;vertical-align: top;}
  .info1-con{width:763px;margin:0 auto;}
  .info1-con>p{font:normal 300 25px 'microsoft yahei';color:#595957;text-indent: 45px;line-height: 60px;}
  .info2-content{width:825px;height:294px;margin:75px auto 50px;}
  #info2 .swiper-slide{width:688px;height:294px;box-shadow:0 8px 30px #ddd;-webkit-filter:brightness(0.7);filter:brightness(0.7);}
  #info2 .swiper-slide-active{-webkit-filter:brightness(1);filter:brightness(1);}
  #info2 .swiper-slide img{display:block;width:100%;}
  #info2 .swiper-button-prev{left:15px;top:45%;width:42px;height:70px;background:url("/static/touch/images/vprev.png") no-repeat;background-position:0 0;background-size:100%}
  #info2 .swiper-button-next{right:15px;top:45%;width:42px;height:70px;background:url("/static/touch/images/vnext.png") no-repeat;background-position:0 0;background-size:100%}
  .info2-1,.info2-2,.info2-3{width:825px;height:689px;overflow:hidden;margin:0 auto;}
  .left-con{width:765px;height:360px;padding-right:35px;}
  .right-pic{width:448px;height:250px;margin:0 auto 40px;}
  .right-pic>img{width:100%;display: block;}
  ...
  .info3-wrap,.info4-wrap{width:798px;overflow:hidden;margin:75px auto;}
  .info3-wrap .info3-left{width:371px;height:515px;display:inline-block;margin-right:40px;}
  .info3-wrap .info3-left>img{width:100%;vertical-align: top;}
  .info3-wrap .info3-right{width:380px;vertical-align: top;display:inline-block;}
  .info3-wrap .info3-right .right-up{width:340px;height:515px;overflow:hidden;padding-right:40px;}
  .info4-wrap{margin:45px auto;}
  .info4-wrap .info4-left{width:100%;height:215px;}
  .info4-wrap .info4-right{width:100%;height:720px;overflow: hidden;position:relative;box-sizing: border-box;}
  .info4-wrap .info4-left .tab-wrap{width:100%;height:205px;padding:30px;box-sizing: border-box;}
  .info4-wrap .info4-left .tab-wrap .info4-tab{width:145px;height:145px;margin-right:37px;border-radius:12px;float:left;}
  .info4-wrap .info4-left .tab-wrap .swiper-slide{width:auto;height:100%;}
...
<div class="main-con">
  <div id="info1" class="content-item animated fadeInLeft swiper-container">
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <div class="info1-view">
          <img src="${ctxPath}/static/touch/images/vinfo1-view.png" alt="">
        </div>
        <div class="info1-con">
  ...
  <div class="hide content-item animated fadeInLeft">
    ...
    <div class="info2-1">
      <div class="right-pic">
        <img src="/static/touch/images/vinfo2-floor2.png" alt="">
      </div>
    ...
    <div class="hide info2-2">
      <div class="right-pic">
        <img src="/static/touch/images/vinfo2-floor2x.png" alt="">
      </div>
      <div class="left-con swiper-container">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
    ...
    <div class="hide info2-3">
      <div class="right-pic">
        <img src="/static/touch/images/vinfo2-floor1.png" alt="">
      </div>
      <div class="left-con swiper-container">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
  ...
  <div class="hide content-item animated fadeInLeft">
    <div class="info3-wrap">
      <div class="info3-left"><img src="/static/touch/images/vinfo3-pic.png" alt=""></div>
      ...
      <div class="dashed" style="margin:55px 0;"></div>
      <div class="right-down" style="text-align: center;"><img style="width:631px;height:301px" src="/static/touch/images/vinfo3-floor.png" alt=""></div>
    </div>
  </div>
  <div class="hide content-item animated fadeInLeft ">
    <div class="info4-wrap">
      <div class="info4-left">
        <div class="tab-wrap swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="info4-tab active"><img src="/static/touch/images/info4-card1.png" alt=""></div>
              <div class="info4-tab"><img src="/static/touch/images/info4-card2.png" alt=""></div>
              <div class="info4-tab"><img src="/static/touch/images/info4-card3.png" alt=""></div>
              <div class="info4-tab"><img src="/static/touch/images/info4-card1.png" alt=""></div>
              <div class="info4-tab"><img src="/static/touch/images/info4-card2.png" alt=""></div>
            </div>
          </div>
        </div>
  ...
  $(function(){
    $('.main-tab .tab').click(function(){
      ...
      if($(this).index()===0){
        ...
        $('.main-con .content-item').eq(3).css('display','block');
        con4();
        let info4=new Swiper('.info4-left .swiper-container', {
